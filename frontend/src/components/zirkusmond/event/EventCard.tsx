...
const EventCard = ({
  ...
  return (
    <Card
      ref={cardRef}
      className={cn(
        "relative mx-auto h-full w-full min-w-70 max-w-112.5 cursor-pointer justify-between border-[5px] border-double border-[#e7b548] bg-black/20 pt-0 transition-all duration-300 hover:-translate-y-1 hover:border-[#e7b548]/80 hover:bg-black/10",
        isVisible
