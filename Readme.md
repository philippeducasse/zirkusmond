...
Website and booking platform for Zirkusmond: show listings, ticket reservations, QR-code ticket scanning, venue rentals, and a newsletter, backed by a Django app with a TanstackStart frontend.
