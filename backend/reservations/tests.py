...
class ReserveViewTest(TestCase):
    ...
    def test_post_valid_creates_reservation(self) -> None:
    ...
    def test_post_valid_creates_payment_and_redirects(self) -> None:
    ...
    def test_post_with_guests_creates_guest_objects(self) -> None:
    ...
    def test_post_invalid_missing_name_rerenders(self) -> None:
    ...
    def test_valid_custom_price_with_guests_creates_all_records(self) -> None:
        data = self._post_data(
            **{
                "res-attendee_count": 2,
                "gues-0-first_name": "Bob",
    ...
    def test_get_nonexistent_show_returns_404(self) -> None:
        response = self.client.get("/reserve/99999")
        self.assertEqual(response.status_code, 404)

    def test_newsletter_checkbox_creates_registration(self) -> None:
